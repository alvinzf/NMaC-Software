...
@section('content')
<script>
    var id = window.location.pathname.replace('/day/', '');
    let url = '{{ route("api-day", ":id")  }}';
    ...
    <section class="content">
        <div class="center">
            <div class="d-flex justify-content-around">
                ...
                <div class="col-xl-3 col-lg-6 mb-4">
                    <div class="bg-white rounded-lg p-5 shadow">
                        <h2 class="h6 font-weight-bold text-center mb-4">Jam Tertinggi</h2>
                        @foreach ($most as $most)
                        <div class="yprogress mx-auto">
                            <div class="xprogress-value w-100 h-100 rounded-circle d-flex align-items-center justify-content-center">
                                <div class="h4 font-weight-bold"> {{$most->Hours}}</div>
                            </div>
                        </div>
                        @endforeach
                        <div class="row text-center mt-4">
    ...
    <table class="table table-bordered data-table">
        <thead>
            <tr>
                ...
                <th scope="col" style="width: 20%">Sensor</th>
                <th scope="col" style="width: 20%">Desibel</th>
                <th scope="col" style="width: 30%">Klasifikasi</th>
